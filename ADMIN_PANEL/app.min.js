    ...
    try {
        ...
        if (data.success) {
            ...
            data.messages.forEach(msg => {
                ...
                const bg = msg.sender_type === 'admin' ? '#1A1A1A' : 'var(--bg-card)';
...
window.sendAdminChatMessage = async function() {
    ...
    const div = document.createElement('div');
    div.style.cssText = `align-self: flex-end; background-color: #1A1A1A; color: #fff; padding: 10px 14px; border-radius: 8px; max-width: 70%; margin-bottom: 8px;`;
    div.innerHTML = `
